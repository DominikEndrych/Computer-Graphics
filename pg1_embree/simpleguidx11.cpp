...
//#pragma omp parallel for
		...
		{		
			...
			{				
				...
				// Supersampling
				local_data[offset] = ((local_data[offset] * (samples - 1)) + pixel.r) / samples;
				local_data[offset + 1] = ((local_data[offset + 1] * (samples - 1)) + pixel.g) / samples;
				local_data[offset + 2] = ((local_data[offset + 2] * (samples - 1)) + pixel.b) / samples;
				local_data[offset + 3] = ((local_data[offset + 3] * (samples - 1)) + pixel.a) / samples;
