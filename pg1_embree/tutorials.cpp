...
void save(std::vector<float> & texture3f, const char * filename, const int width, const int height)
{
	...
	fwrite(texture3f.data(), sizeof(float) * 3, width * height, file);
...
int tutorial_2()
{
	...
	// Denoising code at this point
	Texture texture("../../../data/noise/test4.png");
...
int tutorial_3( const std::string file_name, const char * config )
{
	...
	/*
	Raytracer raytracer(640, 480, deg2rad(45.0),
		Vector3(3, 1, 0), Vector3(0, 0, 0), config);
	*/
	
	
	
	// Cornell box
	Raytracer raytracer(160, 120, deg2rad(40.0), Vector3(0, -760, 250), Vector3(0, 0, 250), config);

	// Furnace test on cornel box
	//Raytracer raytracer(320, 240, deg2rad(40.0), Vector3(0, -760, 250), Vector3(0, 0, 250), config);
	
	/*
	Raytracer raytracer(640, 480, deg2rad(45.0),
		Vector3(75, -140, 80), Vector3(0, 0, 35), config);
	*/
